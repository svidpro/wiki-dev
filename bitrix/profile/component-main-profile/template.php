	...
	<form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>" enctype="multipart/form-data">
		...
		<td><input type="text" name="TITLE" value="<?=$arResult["arUser"]["TITLE"]?>" /></td>
				...
				<tr>
					...
					<td><input type="text" name="NAME" class="form-control" maxlength="50" value="<?=$arResult["arUser"]["NAME"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('LAST_NAME')?></td>
					<td><input type="text" name="LAST_NAME" class="form-control" maxlength="50" value="<?=$arResult["arUser"]["LAST_NAME"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('USER_MOBILE')?></td>
					<td><input type="text" name="PERSONAL_MOBILE" class="form-control" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_MOBILE"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('SECOND_NAME')?></td>
					<td><input type="text" name="SECOND_NAME" class="form-control" maxlength="50" value="<?=$arResult["arUser"]["SECOND_NAME"]?>" /></td>
				</tr>
				<tr>
					<td><?=GetMessage('EMAIL')?><?if($arResult["EMAIL_REQUIRED"]):?><span class="starrequired">*</span><?endif?></td>
					<td><? echo $arResult["arUser"]["EMAIL"]?><?/*<input type="text" name="EMAIL" maxlength="50" value="<? echo $arResult["arUser"]["EMAIL"]?>" />*/?></td>
				</tr>
				<tr>
					<td><?=GetMessage('LOGIN')?><span class="starrequired">*</span></td>
					<td><? echo $arResult["arUser"]["LOGIN"]?><?/*<input type="text" name="LOGIN" maxlength="50" value="<? echo $arResult["arUser"]["LOGIN"]?>" />*/?></td>
				</tr>
				<?if($arResult['CAN_EDIT_PASSWORD']):?>
					<tr>
					<td><?=GetMessage('NEW_PASSWORD_REQ')?></td>
					<td><input type="password" name="NEW_PASSWORD" class="form-control" maxlength="50" value="" autocomplete="off" class="bx-auth-input" />
				...
				<span class="bx-auth-secure" title="<?echo GetMessage("AUTH_NONSECURE_NOTE")?>">
					...
					<tr>
						...
						<td><input type="password" name="NEW_PASSWORD_CONFIRM" class="form-control" maxlength="50" value="" autocomplete="off" /></td>
					</tr>
				<?endif?>
		...
		<?if($arParams["INCLUDE_PERSONAL_INFO"] == "Y"):?>
		...
		<?if($arParams["INCLUDE_WORK_INFO"] == "Y"):?>
		...
		?>
		<?if ($arParams["INCLUDE_LEARNING"] == "Y"):?>
		...
		<?endif;?>
		<?if($arResult["IS_ADMIN"] && $arParams["INCLUDE_IS_ADMIN"] == "Y"):?>
