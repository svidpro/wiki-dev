...
[Original GitHub Repository](https://github.com/alexey-goloburdin/debian-set-up-for-django)
...
Create new user ([more](https://losst.ru/kak-sozdat-polzovatelya-linux)) and add to sudo group ([more](https://losst.ru/kak-dobavit-polzovatelya-v-gruppu-linux/)):
...
Build from source python 3.7, install with prefix to ~/.python folder:<br>
*install all dependences in one folder. You can delete it's folder and create new. Without delete dependences in your system in all folder.*
...
Delete install files and folder:
```
